        ...
        <div class="container">
            <div class="col-lg-9">
                <div class="main-title mb32 mt50 d-flex justify-content-between align-items-center">Мои резюме
                    <a href="/resume/create?user_id=<?=$_GET["id"]?>" class="link-orange-btn orange-btn my-vacancies-add-btn">Добавить резюме</a><a
                ...
                <div class="tabs mb64">
                    <div class="tabs__content active">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="d-flex">
                                    <div class="paragraph mb8 mr16">У вас <span><?= count($model)?></span> резюме</div>
                                </div>
                                <?php foreach($model as $resume):?>
                                    ...
                                    <div class="row">
                                        <div class="my-resume-dropdown dropdown show mb8">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right"
                                                ...
                                                <a class="dropdown-item" href="/resume/edit?id=<?= $resume->id?>">Редактировать</a>
                                                <a class="dropdown-item" href="/resume/delete?id=<?= $resume->id?>">Удалить</a>
                                            </div>
                                        </div>
                                        <div class="col-xl-12 my-vacancies-block__left-col mb16">
                                            <h2 class="mini-title mb8">
                                                <?= isset($resume->spec->name)?$resume->spec->name:"Не указанно"?>
                                            </h2>
                                            <div class="d-flex align-items-center flex-wrap mb8 ">
                                                <span class="mr16 paragraph"><?= $resume->salary?> ₽</span>
                                                <span class="mr16 paragraph">Опыт работы 3 года</span>
                                                <span class="mr16 paragraph"><?= $resume->user->City_id?></span>
                                            </div>
                                        ...
                                        <div
                                            ...
                                            <div class="d-flex flex-wrap mobile-mb12">
                                                <a class="mr16" href="/resume/view?id=<?= $resume->id?>">Открыть</a>
                                            </div>
